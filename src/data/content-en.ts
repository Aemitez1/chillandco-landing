    ...
    items: [
        {
            ...
            title: "24/7 Auto AI Reply",
            desc: "Answer customer questions in real-time without days off, no missed messages",
            highlight: true,
        },
        {
            icon: "Target",
            ...
            desc: "Analyzes if the customer wants to inquire / buy / needs an admin and responds differently",
        },
        {
            icon: "ArrowRightLeft",
            ...
            desc: "If the answer is still unclear, hands over to an admin immediately without wasting the customer's time",
        },
        {
            icon: "MessageCircle",
            ...
            desc: "Always uses polite particles, building a good brand image for your shop",
        },
        {
            icon: "Zap",
            iconColor: "text-yellow-600",
            iconBg: "bg-yellow-50",
            title: "Fast Reply < 4 Seconds",
            desc: "Gemini responds in 2-4 seconds, complete with a loading animation so the customer knows it is typing",
        },
        {
            icon: "Brain",
            ...
            desc: "Remembers the last 5 chat messages, providing seamless communication, no need to repeat questions",
        },
        {
            icon: "Globe",
            ...
            desc: "Automatically detects customer language, can respond in both Thai and English",
        },
        {
            icon: "Building2",
            ...
            desc: "Supports multiple shops in a single system, each with its own Channel Token and Knowledge Base",
        },
    ],
};
